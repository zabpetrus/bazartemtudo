...
{
    public class RequisicaoCompraRepository : RepositoryBase<RequisicaoCompra>, IRequisicaoCompraRepository
    {
        public RequisicaoCompraRepository(ApplicationDBContext context) : base(context)
        {
        }
    }
}
