...
{
    public class TransportadorasRepository : RepositoryBase<Transportadoras>, ITransportadorasRepository
    {
        public TransportadorasRepository(ApplicationDBContext context) : base(context)
        {
        }
    }
}
