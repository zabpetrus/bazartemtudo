...
{
    public class UsuarioInternoRepository : RepositoryBase<UsuarioInterno>, IUsuarioInternoRepository
    {
        public UsuarioInternoRepository(ApplicationDBContext context) : base(context)
        {
        }
    }
}
