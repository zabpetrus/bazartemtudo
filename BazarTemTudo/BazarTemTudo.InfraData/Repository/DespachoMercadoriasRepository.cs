...
{
    public class DespachoMercadoriasRepository : RepositoryBase<DespachoMercadorias>, IDespachoMercadoriasRepository
    {
        public DespachoMercadoriasRepository(ApplicationDBContext context) : base(context)
        {
        }
    }
}
