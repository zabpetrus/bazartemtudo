...
{
    public class ItensPedidosRepository : RepositoryBase<ItensPedidos>, IItensPedidosRepository
    {
        public ItensPedidosRepository(ApplicationDBContext context) : base(context)
        {
        }
    }
}
