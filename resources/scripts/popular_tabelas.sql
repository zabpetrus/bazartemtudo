...
INSERT INTO Produtos  ( product_name, sku, upc, valor,Data_Registro, Data_Atualizacao) 
SELECT DISTINCT Carga.product_name,Carga.sku, Carga.upc, Carga.item_price, GETDATE(), GETDATE() FROM Carga 
LEFT JOIN 
