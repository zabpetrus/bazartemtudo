...
{
    public class DespachoMercadoriasService : ServiceBase<DespachoMercadorias>, IDespachoMercadoriasService
    {
        private readonly IDespachoMercadoriasRepository _repository;
        public DespachoMercadoriasService(IDespachoMercadoriasRepository Repository) : base(Repository)
        {
